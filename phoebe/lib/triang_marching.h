...
struct Tmarching: public Tbody {
  ...
  */
  ...
  //#define DEBUG
  void create_internal_vertex(T r[3], T g[3], Tvertex & v, const T & phi = 0, const T kmin = 0){
        ...
        //
        {
          ...
          if (nt > 1) {
            ...
            for (int k = 1; k < nt && error == 0; ++k, ++n, ++vp){
              ...
              if (!slide_over_potential(it_min->r, it_min->b[2], u, delta_local, *vp, max_iter) &&
                  !project_onto_potential(qk, *vp, max_iter, it_min->b[2])) {
