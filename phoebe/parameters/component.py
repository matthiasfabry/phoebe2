...
def envelope(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [FloatParameter(qualifier='delta_reduction_factor', latexfmt=r'\delta_{\mathrm{{mesh}}', value=kwargs.get('delta_reduction_factor', 1.0), default_unit=u.dimensionless_unscaled, description='Scaling of mesh triangles')]
